...
function App() {
  return (
    <div className="w-full h-screen flex items-center justify-center text-2xl bg-gray-200">
      <div className="w-[80%] h-[60%] drop-shadow-[5px_5px_10px_rgba(0,0,0,0.2)] rounded-xl relative overflow-hidden flex">
